...
public class Request implements Serializable {
    ...
    /**
     * Логин пользователя, который отправляется вместе с пакетом на сервер
     */
    private final String login;

    /**
     * Пароль пользователя, который отправляется вместе с пакетом на сервер
     */
     ...
     */
    public Request(String commandName, String argument, LabWork objectArgument, String login, String password) {
        this.login = login;
    ...
    /**
     * Геттер для получения логина отправителя
     * @return логин в строковом представлении
     */
    public String getLogin() {return login;}

    /**
     * Геттер для получения пароля отправителя
