...
public class LabWork implements Comparable<LabWork>, Serializable {
    /**
     * Серийный номер объекта для передачи
     */
    ...
    /**
     * Логин пользователя, создавшего этот объект
     * Нужен для разграничения права доступа на перезапись
     */
     ...
     * @new Добавилось поле владельца объекта
     */
    @Override
    public String toString() {
        return "Labwork[\n" +
                "  id = " + id + ",\n" +
                "  name = '" + name + "',\n" +
                "  owner = '" + (ownerLogin != null ? ownerLogin : "system") + "',\n" + // Добавили владельца
                ...
                "  author = " + (author != null ? author : "null") + "\n" + // Выводим весь объект автора (через его toString)
                "]";
    }
    ...
    /**
     * Геттер для получения даты создания объекта
    ...
    /**
     * Геттер логина владельца объекта
     * @return строковое представление логина владельца объекта
     */
    ...
    /**
     * Геттер описания к лабораторной работе
     * @return описание к лабев строковом представлении
     */
    ...
    /**
     * Геттер для получения вовлечённости к работе
     * @return уровень вовлечённости
     */
    ...
    /**
     * Устанавливает логин владельца объекта.
     * @param ownerLogin логин пользователя из базы данных.
     */
