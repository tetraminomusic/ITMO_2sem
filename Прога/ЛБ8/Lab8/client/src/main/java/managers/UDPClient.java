...
public class UDPClient {
    ...
    public Response receiveResponse() throws IOException {
        ...
        try {
            ...
            return new Response("\u001B[31mОшибка:\u001B[0m Сервер не отвечает. Убедитесь, что он запущен.", false, null);
        } catch (ClassNotFoundException e) {
            return new Response("\u001B[31mОшибка:\u001B[0m Полученные данные невалидны", false, null);
        }
